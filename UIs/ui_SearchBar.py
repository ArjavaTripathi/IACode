...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(120, 70, 541, 421))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.BackButton = QtWidgets.QPushButton(self.centralwidget)
        self.BackButton.setGeometry(QtCore.QRect(560, 530, 75, 23))
        self.BackButton.setObjectName("BackButton")
        self.BackButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.BackButton_2.setGeometry(QtCore.QRect(650, 530, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BackButton_2.setText(_translate("MainWindow", "Go"))
