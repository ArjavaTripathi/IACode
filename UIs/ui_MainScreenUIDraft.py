...
# Form implementation generated from reading ui file 'MainScreenUIDraft.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.SaveButton.setGeometry(QtCore.QRect(10, 400, 91, 31))
        self.SaveButton.setObjectName("SaveButton")
        self.IgnoredText = QtWidgets.QLabel(Dialog)
        self.IgnoredText.setGeometry(QtCore.QRect(220, 400, 261, 51))
        font = QtGui.QFont()
        ...
        self.EditButton.setGeometry(QtCore.QRect(120, 400, 91, 31))
        self.EditButton.setObjectName("EditButton")
        self.SearchBar = QtWidgets.QLineEdit(Dialog)
        self.SearchBar.setGeometry(QtCore.QRect(370, 20, 291, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.SearchBar.setFont(font)
        self.SearchBar.setObjectName("SearchBar")
        self.GoButton = QtWidgets.QPushButton(Dialog)
        self.GoButton.setGeometry(QtCore.QRect(550, 60, 91, 31))
        self.GoButton.setObjectName("GoButton")
        self.NumberEdit = QtWidgets.QLineEdit(Dialog)
        self.NumberEdit.setGeometry(QtCore.QRect(530, 390, 113, 20))
        self.NumberEdit.setObjectName("NumberEdit")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(510, 420, 161, 16))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.SETButton = QtWidgets.QPushButton(Dialog)
        self.SETButton.setGeometry(QtCore.QRect(550, 440, 75, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Set Max Entertainment"))
